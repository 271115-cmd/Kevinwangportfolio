...
export const MONUMENTS = [
  ...
  { id: 'xiannongtan', archetype: 'altar',
    ...
    spatial: { pos: 0.096, side: 'west', scale: 2.6 },
  ...
  { id: 'tiantan', archetype: 'temple',
    ...
    spatial: { pos: 0.096, side: 'east', scale: 4.0 },
    historical: { year: 1420, era: 'Ming' },
  ...
  { id: 'zhengyangmen', archetype: 'gate',
    ...
    spatial: { pos: 0.262, side: 'center', scale: 3.0 },
  ...
  { id: 'south-road', archetype: 'road',
    ...
    spatial: { pos: 0.328, side: 'center', scale: 1.4 },
  ...
  { id: 'tiananmen-square', archetype: 'square',
    ...
    spatial: { pos: 0.395, side: 'center', scale: 4.4 },
  ...
  { id: 'tiananmen', archetype: 'gate',
    ...
    spatial: { pos: 0.461, side: 'center', scale: 3.2 },
  ...
  { id: 'jinshui', archetype: 'bridge',
    ...
    spatial: { pos: 0.528, side: 'center', scale: 1.6 },
    historical: { year: 1420, era: 'Ming' },
  ...
  { id: 'duanmen', archetype: 'gate',
    ...
    spatial: { pos: 0.594, side: 'center', scale: 2.6 },
    historical: { year: 1420, era: 'Ming' },
  ...
  { id: 'forbidden-city', archetype: 'palace',
    ...
    spatial: { pos: 0.660, side: 'center', scale: 5.0 },
  ...
  { id: 'taimiao', archetype: 'temple',
    ...
    spatial: { pos: 0.727, side: 'east', scale: 3.0 },
    historical: { year: 1420, era: 'Ming' },
  ...
  { id: 'shejitan', archetype: 'altar',
    ...
    spatial: { pos: 0.727, side: 'west', scale: 3.0 },
    historical: { year: 1420, era: 'Ming' },
  ...
  { id: 'jingshan', archetype: 'hill',
    ...
    spatial: { pos: 0.793, side: 'center', scale: 3.6 },
    historical: { year: 1420, era: 'Ming' },
  ...
  { id: 'wanning', archetype: 'bridge',
    ...
    spatial: { pos: 0.897, side: 'center', scale: 1.6 },
