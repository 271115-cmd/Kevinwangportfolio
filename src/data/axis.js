...
export const MONUMENTS = [
  ...
  { id: 'zhengyangmen', archetype: 'gate',
    ...
    spatial: { pos: 0.167, side: 'center', scale: 3.0 },
  ...
  { id: 'south-road', archetype: 'road',
    ...
    spatial: { pos: 0.25, side: 'center', scale: 1.4 },
  ...
  { id: 'tiananmen-square', archetype: 'square',
    ...
    spatial: { pos: 0.333, side: 'center', scale: 4.4 },
  ...
  { id: 'tiananmen', archetype: 'gate',
    ...
    spatial: { pos: 0.417, side: 'center', scale: 3.2 },
  ...
  { id: 'jinshui', archetype: 'bridge',
    ...
    spatial: { pos: 0.50, side: 'center', scale: 1.6 },
    historical: { year: 1420, era: 'Ming' },
  ...
  { id: 'duanmen', archetype: 'gate',
    ...
    spatial: { pos: 0.583, side: 'center', scale: 2.6 },
    historical: { year: 1420, era: 'Ming' },
  ...
  { id: 'forbidden-city', archetype: 'palace',
    ...
    spatial: { pos: 0.667, side: 'center', scale: 5.0 },
  ...
  { id: 'taimiao', archetype: 'temple',
    ...
    spatial: { pos: 0.75, side: 'east', scale: 3.0 },
    historical: { year: 1420, era: 'Ming' },
  ...
  { id: 'shejitan', archetype: 'altar',
    ...
    spatial: { pos: 0.75, side: 'west', scale: 3.0 },
    historical: { year: 1420, era: 'Ming' },
  ...
  { id: 'jingshan', archetype: 'hill',
    ...
    spatial: { pos: 0.833, side: 'center', scale: 3.6 },
    historical: { year: 1420, era: 'Ming' },
  ...
  { id: 'wanning', archetype: 'bridge',
    ...
    spatial: { pos: 0.917, side: 'center', scale: 1.6 },
